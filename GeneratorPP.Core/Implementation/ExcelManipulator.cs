...
namespace GeneratorPP.Core.Implementation
{
    ...
    public class ExcelManipulator
    {
        ...
        public ExcelManipulator(IBySquareEncoder bySquareEncoder, IImageManipulator imageManipulator, IProgress<int> progressReporter)
        {
        ...
        private void FillInPayData(Pay pay, string? paymentPurpose, List<Row> newRows)
        {
            ...
            {
                var amount = pay.Payments[0].Amount.GetValueOrDefault()
